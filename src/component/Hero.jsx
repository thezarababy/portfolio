...
const Hero = () => {
  return (
    <div
      id="hero"
      className=" pt-30 flex px-11 justify-between items-center h-screen max-w-[1440px]"
    >
      <main className="flex  flex-col text-slate-700 ">
        ...
        <p className="text-2xl w-2/3 py-4">
